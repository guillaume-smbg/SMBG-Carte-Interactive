...
/* Décalage initial OPTION B (recentrage visuel) */
map.whenReady(() => {
    map.panBy([162, 0]);  // ⭐ Déplacement initial pour recentrer la France
});
...
async function init() {
    ...
    /* RESET → referme panneau + vide contenu */
